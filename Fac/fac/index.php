...
<head>
    ...
    <script src="angular/lib/jcs-auto-validate.js"></script>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-mini"><b> {{ config.iniciales[0] }} </b> {{ config.iniciales | quitarletra }}
                    </span>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{ config.anio }} <a href=" {{ config.web }}" target="_blank">{{
                        config.empresa }}</a>.</strong> All rights reserved.
        </footer>
